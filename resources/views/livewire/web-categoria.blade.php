                          ...
                          <div class="modal-content">
                            ...
                            @else
                              ...
                              <div class="modal-footer">
                                <button type="button" class="btn btn-primary" wire:click='mostrar' ><i class="fas fa-eye"> </i></button>
                                <button data-dismiss="modal" aria-label="Close" type="button" class="btn btn-danger" wire:click='añadirCalzado({{Auth::user()->id}},{{$calzado->idCalzado}})' >
