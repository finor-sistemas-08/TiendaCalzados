<a href="#" type="button" class="btn btn-sm btn-success" data-toggle="modal" data-target="#update-usuario{{ $usuario->id }}">
    <i class="fas fa-edit"></i>
</a>
<div id="update-usuario{{ $usuario->id }}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title" aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                @if ($usuario->rol)
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="numeroLicencia" value="{{ $usuario->numeroLicencia}}" >
                    </div>
                @endif
            </div>
